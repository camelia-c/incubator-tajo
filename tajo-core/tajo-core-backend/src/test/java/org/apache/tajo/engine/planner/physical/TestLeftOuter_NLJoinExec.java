...
public class TestLeftOuter_NLJoinExec {
  private TajoConf conf;
  private final String TEST_PATH = "target/test-data/TestLeftOuter_NLJoinExec";
  ...
  @Test
  public final void testLeftOuter_NLJoinExec0() throws IOException, PlanningException {
