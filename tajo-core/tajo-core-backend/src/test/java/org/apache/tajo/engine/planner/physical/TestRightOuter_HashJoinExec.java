...
import static org.junit.Assert.assertTrue;
 ...
 //camelia --
// this is not a physical operator in itself, but it uses the LeftOuter_HashJoinExec with switched inputs order
public class TestRightOuter_HashJoinExec {
  private TajoConf conf;
  private final String TEST_PATH = "target/test-data/TestRightOuter_HashJoinExec";
