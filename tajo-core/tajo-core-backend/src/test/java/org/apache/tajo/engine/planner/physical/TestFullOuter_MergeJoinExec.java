...
import org.apache.tajo.engine.planner.physical.FullOuter_HashJoinExec;
...
public class TestFullOuter_MergeJoinExec {
  private TajoConf conf;
  private final String TEST_PATH = "target/test-data/TestFullOuter_MergeJoinExec";
  ...
  String[] QUERIES = {
      "select dep3.dep_id, dep_name, emp_id, salary from emp3 full outer join dep3 on dep3.dep_id = emp3.dep_id", //0 no nulls
      "select job3.job_id, job_title, emp_id, salary from emp3 full outer join job3 on job3.job_id=emp3.job_id", //1 nulls on the left operand
      "select job3.job_id, job_title, emp_id, salary from job3 full outer join emp3 on job3.job_id=emp3.job_id", //2 nulls on the right side
      "select dep4.dep_id, dep_name, emp_id, salary from emp3 full outer join dep4 on dep4.dep_id = emp3.dep_id", //3 no nulls, right continues after left
      "select emp3.emp_id, first_name, phone_number from emp3 full outer join phone3 on emp3.emp_id = phone3.emp_id", //4 one operand is empty
      "select emp3.emp_id, first_name, phone_number from phone3 full outer join emp3 on emp3.emp_id = phone3.emp_id", //5 one operand is empty
  };

  @Test
  public final void testFullOuter_MergeJoin0() throws IOException, PlanningException {
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin0");
    ...
    // if it chose the hash join , convert to merge join exec
    if (!(proj.getChild() instanceof FullOuter_MergeJoinExec)) {
      //TODO
      BinaryPhysicalExec aJoin = (BinaryPhysicalExec) proj.getChild();
      SeqScanExec outerScan = (SeqScanExec) aJoin.getLeftChild(); //correct is normal order
      SeqScanExec innerScan = (SeqScanExec) aJoin.getRightChild();
      ...
      FullOuter_MergeJoinExec mergeJoin = new FullOuter_MergeJoinExec(ctx,
          ((FullOuter_HashJoinExec)aJoin).getPlan(), outerSortExec, innerSortExec,
  ...
  @Test
  public final void testFullOuter_MergeJoin1() throws IOException, PlanningException {
    Fragment[] emp3Frags = StorageManager.splitNG(conf, "emp3", emp3.getMeta(), emp3.getPath(),
        Integer.MAX_VALUE);
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin1");
    TaskAttemptContext ctx = new TaskAttemptContext(conf,
        TUtil.newQueryUnitAttemptId(), merged, workDir);
  ...
  @Test
  public final void testFullOuter_MergeJoin2() throws IOException, PlanningException {
    Fragment[] emp3Frags = StorageManager.splitNG(conf, "emp3", emp3.getMeta(), emp3.getPath(),
        Integer.MAX_VALUE);
    Fragment[] job3Frags = StorageManager.splitNG(conf, "job3", job3.getMeta(), job3.getPath(),
        Integer.MAX_VALUE);
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin2");
    TaskAttemptContext ctx = new TaskAttemptContext(conf,
        TUtil.newQueryUnitAttemptId(), merged, workDir);
  ...
  @Test
  public final void testFullOuter_MergeJoin3() throws IOException, PlanningException {
    Fragment[] emp3Frags = StorageManager.splitNG(conf, "emp3", emp3.getMeta(), emp3.getPath(),
        Integer.MAX_VALUE);
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin3");
    TaskAttemptContext ctx = new TaskAttemptContext(conf,
        TUtil.newQueryUnitAttemptId(), merged, workDir);
  ...
  @Test
  public final void testFullOuter_MergeJoin4() throws IOException, PlanningException {
    Fragment[] emp3Frags = StorageManager.splitNG(conf, "emp3", emp3.getMeta(), emp3.getPath(),
        Integer.MAX_VALUE);
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin4");
    TaskAttemptContext ctx = new TaskAttemptContext(conf,
        TUtil.newQueryUnitAttemptId(), merged, workDir);
    ...
    if (!(proj.getChild() instanceof FullOuter_MergeJoinExec)) {
      ...
      Schema dep4Schema = catalog.getTableDesc("phone3").getMeta().getSchema();
      innerSortKeys[0] = new SortSpec(
          dep4Schema.getColumnByName("emp_id"));
      SortNode innerSort = new SortNode(innerSortKeys);
      innerSort.setInSchema(innerScan.getSchema());
      innerSort.setOutSchema(innerScan.getSchema());
   ...
   @Test
  public final void testFullOuter_MergeJoin5() throws IOException, PlanningException {
    Fragment[] emp3Frags = StorageManager.splitNG(conf, "emp3", emp3.getMeta(), emp3.getPath(),
        Integer.MAX_VALUE);
    Fragment[] phone3Frags = StorageManager.splitNG(conf, "phone3", phone3.getMeta(), phone3.getPath(),
        Integer.MAX_VALUE);
    ...
    Path workDir = CommonTestingUtil.getTestDir("target/test-data/testFullOuter_MergeJoin5");
    TaskAttemptContext ctx = new TaskAttemptContext(conf,
        TUtil.newQueryUnitAttemptId(), merged, workDir);
